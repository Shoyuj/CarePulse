...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/appointments/ics/**").permitAll()
                        ...
                        .requestMatchers("/api/appointments/**", "/api/prescriptions/**", "/api/notifications/**").authenticated()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow all origin patterns (supports Netlify, localhost, Vercel, custom domains with credentials)
